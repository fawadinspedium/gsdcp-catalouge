         ...
         ${
            page.map(({dogs})=>(
              dogs.map((dog)=>(
                   ...
                   ${
                     dog.map(({microchip,dob,sire_name,dam_name,catalog_id,dog_name,KP,sire_KP,dam_KP,breeder,owners,dam_reg_no,sire_reg_no},ind)=>(
                       `
                       ${
                  ...
                  <span class="fw-bold">${dog_name}</span>, ${
                          ...
                          +", "+new Date(dob).toDateString().substring(10)}+", "+${microchip}</p>
                         ${
